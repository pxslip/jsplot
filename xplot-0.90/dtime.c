...
int dtime_cmp(coord c1, coord c2)
{
  if (c1.d > c2.d)
    return 1;
  else if (c1.d < c2.d)
...
coord dtime_add(coord c1, coord c2)
{
  coord r;
  r.d = c1.d + c2.d;
  return r;
...
coord dtime_subtract(coord c1, coord c2)
{
  coord r;
  r.d = c1.d - c2.d;
  return r;
...
coord dtime_round_up(coord c1, coord c2)
{
  coord r;
...
coord dtime_round_down(coord c1, coord c2)
{
  coord r;
...
coord dtime_unmap(coord c1, coord c2, int n, double x)
{
  coord r;
